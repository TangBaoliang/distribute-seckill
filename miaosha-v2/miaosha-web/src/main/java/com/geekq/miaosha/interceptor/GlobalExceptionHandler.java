...
import com.geekq.miasha.enums.resultbean.AbstractResult;
...
public class GlobalExceptionHandler {
    ...
    public AbstractResult exceptionHandler(Exception e) {
        e.printStackTrace();
        if (e instanceof GlobleException) {
            ...
            return ResultGeekQ.error(SESSION_ERROR).withError(msg);
        } else {
